...
public class Colecciones {
    ...
    public static void main(String[] args) {
        ...
        frutas.add("Mango");                // con la implementación HashSet
        frutas.add("Manzana");
        frutas.add("Durazno");
        frutas.add("Pera");
        frutas.add("Cereza");
        ...
        // por lo que solo se guarda un solo "Mango"
        ...
        frutasList.add("Durazno");
        frutasList.add("Pera");
        frutasList.add("Cereza");
        frutasList.add("Mandarina");
        frutasList.add("Carambola");
        frutasList.add("Maracuya");
        frutasList.add("Platano");
        // Nos volvera a guardar otro "Mango", ya que admite elementos repetidos:
        frutasList.add("Mango");

        for (String fruta: frutasList) {
            System.out.println(fruta);
        }
        int pera = frutasList.indexOf("Pera");
        System.out.println("\n" + frutasList.get(pera));
